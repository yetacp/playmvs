...
::A main.s
$$
//SYSUT2     DD DSN=HMVS01.SOURCE(ADDER),DISP=SHR
//SYSPRINT   DD SYSOUT=*
//SYSOUT     DD SYSOUT=*
//SYSIN      DD *
/* ------------------------------------------
...
//SYSUT1     DD DATA,DLM=$$
PROC 2 OP1 OP2
    WRITE [TSO] OP1=&OP1 OP2=&OP2
    ALLOC FI(SYSIN)    DA(*)
    ALLOC FI(SYSPRINT) DA(*)
    ALLOC FI(SYSTERM)  DA(*)
    CALL 'HMVS01.LOAD(ADDER)' '&OP1 &OP2'
    FREE FI(SYSIN, SYSPRINT, SYSTERM)
EXIT
$$
//SYSUT2     DD DSN=HMVS01.CLIST(ADDER),DISP=SHR
//SYSPRINT   DD SYSOUT=*
//SYSOUT     DD SYSOUT=*
//SYSIN      DD *
/* ------------------------------------------
...
//           UNIT=SYSDA,
//           SPACE=(1700,(300,50))
//SYSIN     DD DSN=HMVS01.SOURCE(ADDER),DISP=SHR
//SYSGO     DD DSN=HMVS01.OBJ(ADDER),DISP=SHR
/* ------------------------------------------
//LINK     EXEC LKED
//SYSLMOD   DD DSN=HMVS01.LOAD(ADDER),DISP=SHR
