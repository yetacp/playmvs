...
::A main.s
$$
//SYSUT2     DD DSN=HMVS01.SOURCE(FSS02),DISP=SHR
//SYSPRINT   DD SYSOUT=*
//SYSOUT     DD SYSOUT=*
//SYSIN      DD *
/* ------------------------------------------
...
PROC 0
    ...
    ALLOC FI(SYSTERM)  DA(*)
    CALL 'HMVS01.LOAD(FSS02)'
    FREE FI(SYSIN, SYSPRINT, SYSTERM)
EXIT
$$
//SYSUT2     DD DSN=HMVS01.CLIST(FSS02),DISP=SHR
//SYSPRINT   DD SYSOUT=*
//SYSOUT     DD SYSOUT=*
//SYSIN      DD *
/* ------------------------------------------
...
//SYSIN     DD DSN=HMVS01.SOURCE(FSS02),DISP=SHR
//SYSGO     DD DSN=HMVS01.OBJ(FSS02),DISP=SHR
/* ------------------------------------------
//LINK     EXEC LKED
//SYSLMOD DD DSN=HMVS01.LOAD(FSS02),DISP=SHR
