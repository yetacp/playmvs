...
::A main.s
$$
//SYSUT2     DD DSN=HMVS01.SOURCE(VSAM01),DISP=SHR
//SYSPRINT   DD SYSOUT=*
//SYSOUT     DD SYSOUT=*
//SYSIN      DD *
/* ------------------------------------------
...
::A vsam.s
$$
//SYSUT2     DD DSN=HMVS01.SOURCE(VSAM),DISP=SHR
//SYSPRINT   DD SYSOUT=*
//SYSOUT     DD SYSOUT=*
//SYSIN      DD *
/* ------------------------------------------
...
PROC 0
    ...
    ALLOC FI(SYSTERM)  DA(*)
    CALL 'HMVS01.LOAD(VSAM01)'
    FREE FI(SYSIN, SYSPRINT, SYSTERM)
EXIT
$$
//SYSUT2     DD DSN=HMVS01.CLIST(VSAM01),DISP=SHR
//SYSPRINT   DD SYSOUT=*
//SYSOUT     DD SYSOUT=*
//SYSIN      DD *
/* ------------------------------------------
...
::A execute.jcl
$$
//SYSUT2     DD DSN=HMVS01.CNTL(VSAM01),DISP=SHR
//SYSPRINT   DD SYSOUT=*
//SYSOUT     DD SYSOUT=*
//SYSIN      DD *
/* ------------------------------------------
...
//SYSIN     DD DSN=HMVS01.SOURCE(VSAM01),DISP=SHR
//SYSGO     DD DSN=HMVS01.OBJ(VSAM01),DISP=SHR
/* ------------------------------------------
//ASM02    EXEC ASMFC,
//           MAC1='SYS2.MACLIB',
//           MAC2='PDPCLIB.MACLIB',
...
//SYSUT2    DD DSN=&&SYSUT2,UNIT=SYSDA,SPACE=(1700,(300,50))
//SYSUT3    DD DSN=&&SYSUT3,UNIT=SYSDA,SPACE=(1700,(300,50))
//SYSIN     DD DSN=HMVS01.SOURCE(VSAM),DISP=SHR
//SYSGO     DD DSN=HMVS01.OBJ(VSAM),DISP=SHR
/* ------------------------------------------
//LINK     EXEC LKED
//SYSLMOD DD DSN=HMVS01.LOAD(VSAM01),DISP=SHR
...
//SYSIN     DD DATA,DLM=$$
 ...
 INCLUDE PRIVLIB(TSO)
 INCLUDE PRIVLIB(SVC)
 INCLUDE PRIVLIB(EXEC)
 INCLUDE PRIVLIB(VSAM)
 INCLUDE PRIVLIB(VSAM01)
 ENTRY @@MAIN
 NAME VSAM01(R)
$$
//