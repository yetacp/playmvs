...
::A main.s
$$
//SYSUT2     DD DSN=HMVS01.SOURCE(VM2),DISP=SHR
//SYSPRINT   DD SYSOUT=*
//SYSOUT     DD SYSOUT=*
//SYSIN      DD *
/* ------------------------------------------
...
PROC 0
    ...
    ALLOC FI(SYSTERM)  DA(*)
    CALL 'HMVS01.LOAD(VM2)'
    FREE FI(SYSIN, SYSPRINT, SYSTERM)
EXIT
$$
//SYSUT2     DD DSN=HMVS01.CLIST(VM2),DISP=SHR
//SYSPRINT   DD SYSOUT=*
//SYSOUT     DD SYSOUT=*
//SYSIN      DD *
/* ------------------------------------------
...
//           UNIT=SYSDA,
//           SPACE=(1700,(300,50))
//SYSIN     DD DSN=HMVS01.SOURCE(VM2),DISP=SHR
//SYSGO     DD DSN=HMVS01.OBJ(VM2),DISP=SHR
/* ------------------------------------------
//LINK     EXEC LKED
//SYSLMOD   DD DSN=HMVS01.LOAD(VM2),DISP=SHR
