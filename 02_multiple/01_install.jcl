...
::A main.s
$$
//SYSUT2     DD DSN=HMVS01.SOURCE(HELLO),DISP=SHR
//SYSPRINT   DD SYSOUT=*
//SYSOUT     DD SYSOUT=*
//SYSIN      DD *
/* ------------------------------------------
...
PROC 0
    ...
    ALLOC FI(SYSTERM)  DA(*)
    CALL 'HMVS01.LOAD(HELLO)'
    FREE FI(SYSIN, SYSPRINT, SYSTERM)
EXIT
$$
//SYSUT2     DD DSN=HMVS01.CLIST(HELLO),DISP=SHR
//SYSPRINT   DD SYSOUT=*
//SYSOUT     DD SYSOUT=*
//SYSIN      DD *
/* ------------------------------------------
...
//SYSUT2    DD DSN=&&SYSUT2,UNIT=SYSDA,SPACE=(1700,(300,50))
//SYSUT3    DD DSN=&&SYSUT3,UNIT=SYSDA,SPACE=(1700,(300,50))
//SYSIN     DD DSN=HMVS01.SOURCE(HELLO),DISP=SHR
//SYSGO     DD DSN=HMVS01.OBJ(HELLO),DISP=SHR
/* ------------------------------------------
//LINK     EXEC LKED
//SYSLMOD DD DSN=HMVS01.LOAD(HELLO),DISP=SHR
...
//SYSIN     DD DATA,DLM=$$
 ...
 INCLUDE PRIVLIB(DISPLAY)
 INCLUDE PRIVLIB(HELLO)
 ENTRY @@MAIN
 NAME HELLO(R)
$$
//
